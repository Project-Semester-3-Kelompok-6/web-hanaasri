    ...
    <div class="container-fluid vh-100 p-0 m-0">
        <div class="d-flex align-items-center justify-content-center vh-100" >
            <div class="card rounded-5 p-4">
                ...
                <form>
                    <div class="mb-3">
                        <label for="kodeVerifikasi" class="form-label">Masukkan Password Baru</label>
                        <input type="email" class="form-control" id="kodeVerifikasi">
                    </div>
                    <div class="mb-3">
                        <label for="kodeVerifikasi" class="form-label">Konfirmasi Password</label>
                        <input type="email" class="form-control" id="kodeVerifikasi">
                    </div>
                    <div class="mb-3 text-center p-0">
                        <button type="submit" class="btn btn-primary w-50 mt-2 text-center">Konfirmasi</button>
                    </div>
                </form>        
            </div>
        </div>
